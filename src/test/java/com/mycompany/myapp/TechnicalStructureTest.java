...
@AnalyzeClasses(packagesOf = DemoJhipsterServiceApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(DemoJhipsterServiceApp.class), alwaysTrue())
